    ...
    <div className="min-h-full flex flex-col">
      ...
      <header className="bg-amz-navy text-white">
        <div className="flex items-center gap-2 px-3 py-2">
          <Link
            to="/"
            className="flex items-end gap-0.5 px-2 py-1 rounded hover:outline hover:outline-1 hover:outline-white/40"
          >
          ...
          >
            ...
            />
            <button
              className="bg-amz-orange hover:bg-amz-yellowDark px-4 flex items-center"
              aria-label="Search"
            >
              <svg
                width="20"
          ...
          <Link
            to="/wallet"
            className="text-xs leading-tight px-2 hover:outline hover:outline-1 hover:outline-white/40 rounded"
          >
          ...
          <div className="text-xs leading-tight px-2">
            <Link to="/signin" className="block text-gray-300 hover:text-white">
              Sign In
            </Link>
            <Link to="/signup" className="block font-bold hover:underline">
              Sign Up
            </Link>
          </div>
          ...
          <Link
            to="/cart"
            className="relative flex items-end px-2 hover:outline hover:outline-1 hover:outline-white/40 rounded"
            aria-label="Cart"
          >
            <CartIcon />
            {count > 0 && (
        ...
        <nav className="bg-amz-slate text-white text-sm">
          <div className="flex items-center gap-1 px-3 py-1.5 overflow-x-auto whitespace-nowrap">
            ...
            <NavLink to="/recommended" className={navLink}>
              For You
            </NavLink>
            <NavLink to="/classifieds" className={navLink}>
              Classifieds
            </NavLink>
