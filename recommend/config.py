...
class RerankConfig:
    ...
    renewed_boost_weight: float = 0.15   # max additive boost for a perfect Renewed item
    health_score_floor: float = 50.0     # below this, no boost (we wouldn't resell anyway)
    health_score_ceil: float = 100.0     # boost saturates here
    discount_boost_weight: float = 0.05  # extra nudge for a genuine price cut vs original
